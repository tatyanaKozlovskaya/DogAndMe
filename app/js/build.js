...
define('fb',['firebase', 'radio', 'Error', 'module'], function (firebase, radio, myError, module) {
    var fairBase = {
...
;
define('router',['jquery', 'jqueryui', 'fb', 'radio'],
...
define('models/asideModel',[],function () {
...
define('text!templates/asideTemplate.html',[],function () { return '<ul class="aside-ul">\n\t<li><a href="#news" >Лента</a></li>\n\t<li><a href="#map">Карта</a></li>\n\t<li><a href="#chat">Чат</a>\n\t<% if(count){ %>\n\t<span class="new-messages-count"><%= count %></span>\n\t<% } %>\n\t</li>\n\t<li><a href="#addPhoto">Добавить фото</li>\n\t<li><a href="#addNews">Добавить новость</a></li>\n\t<li><a href="#settings">Настройки</a></li>\n</ul>';});
...
define('views/asideView',['underscore', 'text!templates/asideTemplate.html', 'radio','jquery','jqueryui','hammer'],
...
define('controllers/asideController',['models/asideModel','views/asideView','radio'],
...
define('models/headerModel',[],function () {
...
define('text!templates/headerTemplate.html',[],function () { return '<div class="logo">\n<h2 class="title is-3">Dog and me</h2>\n</div>\n<div class="autorisation">\n<% if (user){ %>\n<% if(user.dogs){ %>\n    <% if(dogs){ %>\n        <div class="dogs-avatars">\n           <% for (var i=0;i<dogs.length;i++){ %>\n            <div class="user-header-img <% if(dogs[i].id === currentUserDog.id){ %>\n            <% print(\'current-dog\') %>\n           <% }%>">\n                <img class="user-img" \n                <% if(dogs[i] && dogs[i].avatar && dogs[i].avatar.downloadURL){ %>\n                src="<%= dogs[i].avatar.downloadURL %>" \n                <% } else if(dogs[i]){ %> \n                src="img/user_pic.png" \n                <% } %> \n                <% if(dogs[i] && dogs[i].id ){ %>\n                data-id="<%= dogs[i].id %>" \n                <% } %>\n                >\n            </div>\n            <span class="dog-name"  <% if(dogs[i] && dogs[i].id ){ %>\n             data-id="<%= dogs[i].id %>" \n             <% } %>>\n               \n                <% if(dogs[i] && dogs[i].name){ \n                print(dogs[i].name) \n                } else if(dogs[i]){ \n                print(\'dog\') \n                } %>\n               \n                \n             </span>\n            <% } %>\n        </div>\n    <% } %>\n    <span class="dog-and-user-name"><%if(user.name){print(user.name)}else{print(\'Вы\')}%></span>\n  <% } else { %>\n<a href="#signUpStep2" class="add-new-dogs-profile">+</a>\n<% } %>\n\n<div class="user-settings display-none">\n     <div class="close-it">\n        <img src="img/close-img.png" class="close-user-profile">\n    </div>\n       <% if(dogs){ %>\n        <div class="dogs-avatars">\n           <% for (var i=0;i<dogs.length;i++){ %>\n            <div class="user-header-img">\n                <img class="user-img" \n                <% if(dogs[i] && dogs[i].avatar && dogs[i].avatar.downloadURL){ %>\n                src="<%= dogs[i].avatar.downloadURL %>" \n                <% } else if(dogs[i]){ %> \n                src="img/user_pic.png" \n                <% } %> \n                <% if(dogs[i] && dogs[i].id ){ %>\n                data-id="<%= dogs[i].id %>" \n                <% } %>\n                >\n            </div>\n            <span class="dog-name"  <% if(dogs[i] && dogs[i].id ){ %>\n             data-id="<%= dogs[i].id %>" \n             <% } %>>\n               \n                <% if(dogs[i] && dogs[i].name){ \n                print(dogs[i].name) \n                } else if(dogs[i]){ \n                print(\'dog\') \n                } %>\n               \n                \n             </span>\n            <% } %>\n        </div>\n    <% } %>\n    <span class="user-name"><% if( user.name){print(user.name)} %></span>\n    <button class="button sign-out">Выйти</button>\n</div>\n<% } else {%>\n\n\t<a href="#signIn" >Войти</a>\n\t<a href="#signUpStep1" >Зарегистрироваться</a>\n\n<% } %>\n</div>\n\n<div class="clear"></div>';});

define('views/headerView',['underscore','text!templates/headerTemplate.html','radio','fb'],
...
define('controllers/headerController',['models/headerModel', 'views/headerView', 'radio','fb'],
...
define('models/signInModel',[],function () {
...
define('text!templates/signInFormTemplate.html',[],function () { return '<div class="card card-sign-in">\n  <h2 class="title is-2">\n    Dog&amp;Me\n  </h2>\n <div class="field field-email">\n  <label class="label">\n  <p class="control">\n    <input class="input email-input" type="text" placeholder="email">\n  </p>\n  </label>\n</div>\n<div class="field">\n  <label class="label">\n  <p class="control">\n    <input class="input password-input" type="password" placeholder="password">\n  </p>\n  </label>\n</div>\n<div class="field field-sign-in-button">\n<p class="control">\n    <button class="button is-primary sign-in-button">Войти</button>\n  </p>\n</div>\n<div class="field is-grouped">\n  <p class="control">\n    <button class="button sign-in-with-google-button">Войти c Google</button>\n  </p>\n  <p class="control">\n    <a class="button" href="#signUpStep1">Зарегистрироваться</a>\n  </p>\n</div>\n</div>';});

define('views/signInView',['underscore', 'text!templates/signInFormTemplate.html', 'radio','jquery','jqueryui'],
...
define('controllers/signInController',['models/signInModel','views/signInView','radio','fb'],
...
define('text!templates/registrationFormTemplate.html',[],function () { return '<div class="card card-sign-up">\n    <div class="close-it">\n        <a href="#map"><img src="img/close-img.png" class="close-user-profile"></a>\n    </div>\n    <h2 class="title is-2">\n        Шаг 1\n    </h2>\n    <div class="form">\n        <div class="field">\n            <label class="label">Имя:</label>\n            <p class="control">\n                <input class="input registration-name" type="text" placeholder="Имя">\n            </p>\n        </div>\n        <div class="field">\n            <label class="label">Email:</label>\n            <p class="control">\n                <input class="input registration-email" type="text" placeholder="Email">\n            </p>\n        </div>\n         <div class="field">\n            <label class="label">Пароль:</label>\n            <p class="control">\n                <input class="input registration-password" placeholder="password" type="password">\n            </p>\n        </div>\n\n        <div class="field">\n            <p class="control">\n                <button class="button is-primary sign-up-step-2">Далее &rarr;</button>\n            </p>\n        </div>\n\n    </div>\n</div>\n\n';});

define('views/registrationView',['underscore', 'text!templates/registrationFormTemplate.html', 'radio','jquery','jqueryui','fb'],
...
define('models/registrationDogModel',[],function () {
...
define('text!templates/registrationDogFormTemplate.html',[],function () { return '<div class="card card-sign-up">\n     <div class="close-it">\n            <a href="#map"><img src="img/close-img.png" class="close-user-profile"></a>\n        </div>\n      <h2 class="title is-2">\n        Информация о собаке\n      </h2>\n      <div class="form">\n      <div class="user-img">\n          <img class="user-registration-img" src="img/user_pic.png">\n      </div>\n        <div class="field is-horizontal">\n              <div class="field-label is-normal">\n                <label class="label">Загрузить фото:</label>\n              </div>\n              <div class="field-body">\n                <div class="field">\n                  <div class="control">\n                    <input class="input photos-download" type="file">\n                  </div>\n                </div>\n              </div>\n            </div>\n           \n          <div class="field is-horizontal">\n              <div class="field-label is-normal">\n                <label class="label">Имя собаки:</label>\n              </div>\n              <div class="field-body">\n                <div class="field">\n                  <div class="control">\n                    <input class="input dog-name" type="text" placeholder="Dog\'s name">\n                  </div>\n                </div>\n              </div>\n            </div>\n            \n            \n            <div class="field is-horizontal">\n              <div class="field-label">\n                <label class="label">Пол:</label>\n              </div>\n              <div class="field-body">\n                <div class="field">\n                  <div class="control">\n                   <div class="select is-fullwidth">\n                    <select class="gender-dog">\n                        <option value="Девочка">Девочка</option>\n                        <option value="Мальчик">Мальчик</option>\n                      </select>\n                      </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n\n            <div class="field is-horizontal">\n              <div class="field-label is-normal">\n                <label class="label">Порода</label>\n              </div>\n              <div class="field-body">\n                <div class="field">\n                  <div class="control">\n                    <div class="select is-fullwidth">\n                      <select class="breed-of-dog">\n\n                       <% for (var m = 0; m < breedsOfDogs.length; m++) { %>\n                        <option value="<%= breedsOfDogs[m] %>"><%= breedsOfDogs[m] %></option>\n                        <% } %>\n                      </select>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n\n            <div class="field is-horizontal">\n              <div class="field-label is-normal">\n                <label class="label">Дата рождения:</label>\n              </div>\n                 <div class="field-body">\n                    <div class="field">\n                      <div class="control">\n                       <input class="input birthday-dog" type="text" id="datepicker">\n                      </div>\n                    </div>\n              </div>\n            </div>\n\n            <div class="field is-horizontal">\n              <div class="field-label is-normal">\n                <label class="label">Ваш адрес:</label>\n              </div>\n              <div class="field-body">\n                <div class="field">\n                  <div class="control">\n                    <input class="input dog-address" type="text" placeholder="">\n                    <p class="description">Введите Ваш адрес, если поле пустое или адрес в поле не совпадает</p>\n                  </div>\n                </div>\n              </div>\n            </div>\n\n            <div id="mapRegistration"></div>\n            \n           \n\n        <div class="field">\n            <p class="control">\n                <button class="button is-primary sign-up-dog">Создать профиль!</button>\n            </p>\n        </div>\n        <div class="clear"></div>\n    </div>\n</div>';});
...
(function (factory) {
	if (typeof define === 'function' && define.amd) {
		// AMD
		define('jqueryjson',['jquery'], factory);
...
define('ym',['radio', 'Error', 'ymap', 'fb', 'jqueryjson'],
...
define('views/registrationDogView',['underscore', 'text!templates/registrationDogFormTemplate.html', 'radio','jquery','jqueryui','fb', 'ym'],
...
define('controllers/registrationDogController',['models/registrationDogModel','views/registrationDogView','radio','fb'],
...
define('models/profileModel',['fb', 'radio'],
    function (fb, radio) {
...
define('controllers/profileController',['models/profileModel','views/profileView','radio','fb','ym'],
...
define('models/addPhotoModel',['fb','radio'],
	function (fb, radio) {
...
define('text!templates/addPhotoTemplate.html',[],function () { return '<div class="container">\n<% if(user){ %>\n<% if (snapshot) { %>\n    <div class="card">\n        <h2 class="title is-2">\n            Добавить фото\n        </h2>\n        <div class="form">\n            <div class="field">\n                <p class="control">\n                    <div class="photo-container one-photo">\n                         <div class="container-for-photo">\n                             <img class="" \n                                <% if(snapshot && snapshot.downloadURL){ %>\n                                src="<%= snapshot.downloadURL %>" \n                                <% } else if(snapshot){ %> \n                                src="img/user_pic.png" \n                                <% } %> \n                                >\n                         </div>\n                    </div>\n                </p>\n            </div>\n            <div class="field">\n                <label class="label">Добавьте описание:</label>\n                <p class="control">\n                     <textarea class="textarea photo-description" type="text" placeholder="text"></textarea>\n                </p>\n            </div>\n            <div class="field">\n                <p class="control">\n                    <button class="button is-primary upload-photo">Опубликовать</button>\n                    <button class="button is-info cancel-photo">Отмена</button>\n                </p>\n            </div>\n        </div>\n    </div>\n    <% } else { %>\n    <div class="add-photo-big-button">\n            <label class="download-photos-label">+</label>\n            <input class="input download-photos" type="file">\n    </div>\n    <% } %>\n\n<% } else { %>\n    <div>\n        <h4 class="title is-4">Для того, чтобы воспользоваться данной функцией Вам необходимо <a href="#signUpStep1">зарегистрироваться</a></h4>\n    </div>\n<% } %>\n</div>';});

define('views/addPhotoView',['underscore', 'text!templates/addPhotoTemplate.html', 'radio','jquery','jqueryui','fb','router'],
...
define('controllers/addPhotoController',['models/addPhotoModel', 'views/addPhotoView', 'radio', 'fb'],
...
define('models/galleryModel',['fb','radio'],
   function (fb, radio) {
...
define('text!templates/galleryTemplate.html',[],function () { return '<div class="info-block-container">\n<div class="dog-info">\n      <div class="dog-photo">\n        <img class="dog-photo-img" \n                <% if(dogsInfo.avatar.downloadURL){ %>\n                src="<%= dogsInfo.avatar.downloadURL %>" \n                <% } else if(dogsInfo){ %> \n                src="img/user_pic.png" \n                <% } %> \n                <% if(dogsInfo.id ){ %>\n                data-id="<%= dogsInfo.id %>" \n                <% } %>\n                >\n      </div> \n      <span class="dog-name">\n                <% if(dogsInfo.name ){print(dogsInfo.name)} %>\n      </span>\n      <div class="clear"></div>\n</div>\n<div class="flexbin flexbin-margin">\n <% for (var prop in dogsInfo.photos){ %>\n      <div>\n        <img class="gallery-img" \n                <% if(dogsInfo.photos[prop].downloadURL){ %>\n                src="<%= dogsInfo.photos[prop].downloadURL %>" \n                <% } else if(dogsInfo.photos[prop]){ %> \n                src="img/user_pic.png" \n                <% } %> \n                <% if(dogsInfo.photos[prop].description ){ %>\n                data-description="<%= dogsInfo.photos[prop].description %>" \n                <% } %>\n                <% if(dogsInfo.photos[prop].puth ){ %>\n                data-puth="<%= dogsInfo.photos[prop].puth %>" \n                <% } %>\n                <% if(dogId){ %>\n                data-id="<%= dogId %>" \n                <% } %>\n                >\n      </div> \n    <% } %>\n</div>\n</div>\n<div class="popup display-none">\n  <div class="current-photo">\n     <figure>\n     <img src="" class="gallery-popup-photo">\n     <figcaption>\n     <span class="desc">Описание:</span>\n     <span class="gallery-popup-photo-description"></span>\n      <% if (dogsInfo.ownerUid && user && user.uid && dogsInfo.ownerUid === user.uid) { %>\n        <span class="delete-photo">удалить фото</span>\n     <% } %>\n     </figcaption>\n     \n     </figure>\n     <span class="close-popup">X</span>\n  </div>\n</div>';});

define('views/galleryView',['underscore', 'text!templates/galleryTemplate.html', 'radio','jquery','fb'],
...
define('controllers/galleryController',['models/galleryModel','views/galleryView','radio','fb'],
...
define('models/addNewsModel',['fb','radio'],
	function (fb, radio) {
...
define('text!templates/addNewsTemplate.html',[],function () { return '<div class="container">\n<% if(user){ %>\n    <div class="card">\n        <h2 class="title is-2">\n            Добавить новость\n        </h2>\n        <div class="form">\n        <div class="field">\n                <label class="label"></label>\n                <p class="control">\n                     <textarea class="textarea news-description" type="text" placeholder="Что у вас нового?"><% if(description){print(description)}%></textarea>\n                     <div class="add-photo-small-button">\n                        <label class="download-photos-news-label"></label>\n                        <input class="input download-photos" type="file">\n                    </div>\n                     <span class="sos">SOS</span>\n                </p>\n            </div>\n           <% if (snapshot) { %>\n            <div class="field">\n                <p class="control">\n                    <div class="photo-container">\n                        <% for (var prop in snapshot){ %>\n                          <div class="container-for-photo">\n                                <img class="user-img" \n                                <% if(snapshot && snapshot[prop] && snapshot[prop].downloadURL){ %>\n                                src="<%= snapshot[prop].downloadURL %>" \n                                <% } else if(snapshot[prop]){ %> \n                                src="img/user_pic.png" \n                                <% } %> \n                                <% if(snapshot && snapshot[prop] && snapshot[prop].id ){ %>\n                                data-id="<%= snapshot[prop].id %>" \n                                <% } %>\n                                >\n                                <span class="delete-photo" <% if(snapshot && snapshot[prop] && snapshot[prop].id ){ %>\n                                data-id="<%= snapshot[prop].id %>" \n                                <% } %>>X</span>\n                            </div>\n                            <% } %>\n                    </div>\n                </p>\n            </div>\n            <% } %>\n            <div class="field">\n                <p class="control">\n                    <button class="button is-primary upload-news">Опубликовать</button>\n                    <button class="button is-info cancel-news">Отмена</button>\n                </p>\n            </div>\n        </div>\n    </div>\n    <% } else { %>\n    <div>\n        <h4 class="title is-4">Для того, чтобы воспользоваться данной функцией Вам необходимо <a href="#signUpStep1">зарегистрироваться</a></h4>\n    </div>\n    <% } %>\n</div>';});

define('views/addNewsView',['underscore', 'text!templates/addNewsTemplate.html', 'radio','jquery','jqueryui','fb','router'],
...
define('controllers/addNewsController',['models/addNewsModel', 'views/addNewsView', 'radio', 'fb'],
...
define('models/newsFeedModel',['fb','radio'],
	function (fb, radio) {
...
define('text!templates/newsFeedTemplate.html',[],function () { return '  <div class="container">\n  <div class="filter-buttons">\n    <% if(user) { %>\n    <button class=" button followed filtered"> Подписки </button>\n    <button class=" button all"> Все </button>\n    <% } %>\n  </div>\n  <div class="news info-block-container">\n    <div class="news-container">\n       <% if (dogNews){ %>\n        <%  for(var a = 0; a < dogNews.length;a++){ %>\n          <div class="container-for-news \n          <% if(dogNews[a].data && dogNews[a].data.sos && dogNews[a].data.sos === true){print(\'sos\')} %>">\n          <div class="userInfo">\n            <div class="user-img-container">\n              <img class="user-img" \n                <% if(dogNews[a] && dogNews[a].data.avatar && dogNews[a].data.avatar.downloadURL){ %>\n                src="<%= dogNews[a].data.avatar.downloadURL %>" \n                <% } else if(dogNews[a]){ %> \n                src="img/user_pic.png" \n                <% } %> \n                <% if(dogNews[a] && dogNews[a].data.dogId ){ %>\n                data-id="<%= dogNews[a].data.dogId %>" \n                <% } %>\n                >\n            </div>\n            <% if(dogNews[a].data && dogNews[a].data.name){ %>\n               <span class="dog-name"\n                <% if(dogNews[a] && dogNews[a].data.dogId ){ %>\n                data-id="<%= dogNews[a].data.dogId %>" \n                <% } %>>\n                <%= dogNews[a].data.name %>\n                </span>\n            <% } %>\n          <div class="clear"></div>\n          </div>\n          <% if(dogNews[a].data && dogNews[a].data.uid && user && user.uid && dogNews[a].data.uid === user.uid){ %>\n               <span class="delete-news" \n               <% if(dogNews[a].data && dogNews[a].data.id ){ %>\n                 data-id="<%= dogNews[a].data.id %>"\n               <% } %>">X</span>\n            <% } %>\n          <% if(dogNews[a].data && dogNews[a].data.sos && dogNews[a].data.sos === true){ %>\n               <span class="sos-span">SOS</span>\n          <% } %>\n          <%  if(dogNews[a].data && dogNews[a].data.time){ %>\n               <span class="news-time"><%= dogNews[a].data.time %></span>\n          <%  } %>\n          <%  if(dogNews[a].data && dogNews[a].data.description){ %>\n               <div class="news-description"><% print(dogNews[a].data.description) %></div>\n          <%  } %>\n         \n           <%  if(dogNews[a].images){ %>\n             <div class="photo-container">\n              <%  for (var prop in dogNews[a].images){ %>\n                   <div class="gallery-mini-photo news-mini-photo">\n                      <img class="gallery-mini-photo-img news-mini-photo-img" \n                              <% if( dogNews[a].images[prop].downloadURL){ %>\n                              src="<%=  dogNews[a].images[prop].downloadURL %>" \n                              <% } else if( dogNews[a].images[prop]){ %> \n                              src="img/user_pic.png" \n                              <% } %> \n                              <% if( dogNews[a].data.description ){ %>\n                              data-description="<%= dogNews[a].data.description %>" \n                              <% } %>\n                              <% if(dogNews[a].images[prop].puth ){ %>\n                              data-puth="<%= dogNews[a].images[prop].puth %>" \n                              <% } %>\n                              <% if(dogNews[a].data.id){ %>\n                              data-id="<%= dogNews[a].data.id %>" \n                              <% } %>\n                              <% if(dogNews){ %>\n                              data-folder="<%= \'news\' %>" \n                              <% } %>  \n                              <% if(dogNews[a].data.uid){ %>\n                              data-uid="<%= dogNews[a].data.uid %>" \n                              <% } %>                             \n                              >\n                    </div> \n              <%  } %>\n              </div>\n          <%  } %>\n           </div>\n        <%  } %>\n        <%  } %>\n    </div>\n    </div>\n</div>\n    <div class="popup display-none">\n     <div class="current-photo">\n     <figure>\n     <img src="" class="gallery-popup-photo">\n     <figcaption>\n     <span class="desc">Описание:</span>\n     <span class="gallery-popup-photo-description"></span>\n      \n     </figcaption>\n     \n     </figure>\n     <span class="close-popup">X</span>\n  </div>\n</div>';});

define('views/newsFeedView',['underscore', 'text!templates/newsFeedTemplate.html', 'radio','jquery','jqueryui','fb','router'],
...
define('controllers/newsFeedController',['models/newsFeedModel', 'views/newsFeedView', 'radio', 'fb'],
...
define('text!templates/mapTemplate.html',[],function () { return '<div id="map-map"></div>';});

define('views/mapView',['underscore', 'text!templates/mapTemplate.html', 'radio','jquery','fb','ym'],
...
define('controllers/mapController',['models/mapModel','views/mapView','radio','fb','ym'],
...
define('models/chatModel',['fb', 'radio'],
	function (fb, radio) {
...
define('text!templates/chatTemplate.html',[],function () { return '\n\t    <div class="chat-container">\n       <% if(user){ %>\n\t    <% if(chatsInfo.length >= 1){ %>\n\t    <% var allCount = 0 %>\n\t    \t<% for(var i = 0; i < chatsInfo.length; i++ ){ %>\n\t    \t\n\t    \t <div class="all-chats-list">\n\t\t    <div class="chat-preview">\n                <% if(chatsInfo[i].messages){ %>\n                    <% var count = 0 %>\n\t\t\t\t    <% for(var days in chatsInfo[i].messages) { %>\n\t\t\t\t    \t<% for(var message in chatsInfo[i].messages[days]) { %>\n\t\t\t\t            <% if(chatsInfo[i].messages[days][message] && chatsInfo[i].messages[days][message].status && chatsInfo[i].messages[days][message].status === \'unread-\' + currentUserDog.id){ %>\n\t\t\t\t            \t<% count++ %>\n\t\t\t\t            \t<% allCount++ %>\n\n\t\t\t\t            <% } %>\n\t\t\t\t    \t<% } %>\n\t\t\t    \t<% } %>\n\t\t\t    \t\n\t\t\t    \t<% if( count >1 ){ %>\n\t\t\t    \t<span class="newMessages"><%= count %></span>\n\t\t\t    \t<% } %>\n                <% } %>\n                 \n\t\t\t     <div class="dog-info chat-partner">\n\t\t\t    <% for(var prop in chatsInfo[i].membersInfo){ %>\n\t\t\t\t    <% if(chatsInfo[i] && chatsInfo[i].membersInfo && chatsInfo[i].membersInfo[prop] && chatsInfo[i].membersInfo[prop].id && chatsInfo[i].membersInfo[prop].id != currentUserDog.id){ %>\n\t\t\t\t    \t<div class="user-photo-container">\n\t\t\t\t    \t\t<img class="user-img" \n\t\t\t\t                <% if(chatsInfo[i].membersInfo[prop].avatar && chatsInfo[i].membersInfo[prop].avatar.downloadURL){ %>\n\t\t\t\t                src="<%= chatsInfo[i].membersInfo[prop].avatar.downloadURL %>" \n\t\t\t\t                <% } else if(chatsInfo[i].membersInfo[prop]){ %> \n\t\t\t\t                src="img/user_pic.png" \n\t\t\t\t                <% } %> \n\t\t\t\t                <% if(chatsInfo[i].membersInfo[prop].id){ %>\n\t\t\t\t                data-id="<%= chatsInfo[i].membersInfo[prop].id %>" \n\t\t\t\t                <% } %>\n\t\t\t\t                >\n\t\t\t\t    \t</div>\n\t\t\t\t    \t<% if(chatsInfo[i].membersInfo[prop].name){ %>\n\t\t\t\t\t    <span class="chat-name" \n\t\t\t\t\t    \t\t<% if(chatsInfo[i].id){ %>\n\t\t\t\t                data-id="<%= chatsInfo[i].id %>" \n\t\t\t\t                <% } %>>\n\t\t\t\t\t    \t<%= chatsInfo[i].membersInfo[prop].name %>\n\t\t\t\t\t    </span>\n\t\t\t\t\t     <% } %>\n\t\t\t\t    <% } %>\n\t\t\t    <% } %>\n\t            </div>\n\n\t            <div class="last-message"\n\t            \t\t\t <% if(chatsInfo[i].id){ %>\n\t\t\t                data-id="<%= chatsInfo[i].id %>" \n\t\t\t                <% } %>>\n                <% if(chatsInfo[i].messages){ %>\n\t\t\t    <% var daysArr = [] %>\n\t\t\t    <% for(var days in chatsInfo[i].messages) { %>\n\t\t\t    <%  daysArr.push(chatsInfo[i].messages[days]) %>\n\t\t\t    <% } %>\n\n\t\t\t    <% var messagesArr = [] %>\n\t\t\t    <% for(var messages in daysArr[daysArr.length-1]) { %>\n\t\t\t    <% messagesArr.push(daysArr[daysArr.length-1][messages]) %>\n\t\t\t    <% } %>\n\t\t\t    <span><%= messagesArr[messagesArr.length-1].text %></span>   \n\t\t\t    \n\t\t\t    <% if (messagesArr[messagesArr.length-1].text.length >20 ){%> \n\t\t\t    <span class="drops">...</span>\n\t\t\t    <% } %>\n\t\t\t    <% } %>      \t\n\t\t\t    </div>\n\t\t    </div>\n\t\t    </div>\n\n\t        <% } %>\n\t         <% radio.trigger(\'newMessageCount\', allCount) %>\n\n\t    <% } else { %>\n\t\t     <span class="no-messages">\n\t\t     \tСообщений нет\n\t\t     </span>\n\t    <% } %>\n\t    <% } else {%>\n\t     <div>\n        \t<h4 class="title is-4">Для того, чтобы воспользоваться данной функцией Вам необходимо <a href="#signUpStep1">зарегистрироваться</a></h4>\n   \t\t </div>\n\t\t<% } %>\n\t    </div>\n';});

define('views/chatView',['underscore', 'text!templates/chatTemplate.html', 'radio','jquery','fb','ym'],
...
define('models/chatRoomModel',['fb'],
	function (fb) {
...
define('text!templates/chatRoomTemplate.html',[],function () { return '<div class="names">\n\t <% if(user){ %>\n \t\t\t<div class="chat-room-partner">\n\t\t\t    <% for(var prop in chat.membersInfo){ %>\n\t\t\t\t    <% if(chat.membersInfo[prop] && chat.membersInfo[prop].id && chat.membersInfo[prop].id != currentUserDog.id){ %>\n\t\t\t\t    \t<div class="user-photo-container">\n\t\t\t\t    \t\t<img class="user-img" \n\t\t\t\t                <% if(chat.membersInfo[prop].avatar && chat.membersInfo[prop].avatar.downloadURL){ %>\n\t\t\t\t                src="<%= chat.membersInfo[prop].avatar.downloadURL %>" \n\t\t\t\t                <% } else if(chat.membersInfo[prop]){ %> \n\t\t\t\t                src="img/user_pic.png" \n\t\t\t\t                <% } %> \n\t\t\t\t                <% if(chat.membersInfo[prop].id){ %>\n\t\t\t\t                data-id="<%= chat.membersInfo[prop].id %>" \n\t\t\t\t                <% } %>\n\t\t\t\t                >\n\t\t\t\t    \t</div>\n\t\t\t\t    \t<% if(chat.membersInfo[prop].name){ %>\n\t\t\t\t\t    <span class="chat-name">\n\t\t\t\t\t    \t<%= chat.membersInfo[prop].name %>\n\t\t\t\t\t    </span>\n\t\t\t\t\t    <% } %>\n\t\t\t\t    <% } %>\n\t\t\t    <% } %>\n\t        </div>\n\n\t\t\t <div class="my-dog-in-room">\n\t\t\t    <% for(var prop in chat.membersInfo){ %>\n\t\t\t\t    <% if(chat.membersInfo[prop] && chat.membersInfo[prop].id && chat.membersInfo[prop].id == currentUserDog.id){ %>\n\t\t\t\t    \t<div class="user-photo-container">\n\t\t\t\t    \t\t<img class="user-img" \n\t\t\t\t                <% if(chat.membersInfo[prop].avatar && chat.membersInfo[prop].avatar.downloadURL){ %>\n\t\t\t\t                src="<%= chat.membersInfo[prop].avatar.downloadURL %>" \n\t\t\t\t                <% } else if(chat.membersInfo[prop]){ %> \n\t\t\t\t                src="img/user_pic.png" \n\t\t\t\t                <% } %> \n\t\t\t\t                <% if(chat.membersInfo[prop].id){ %>\n\t\t\t\t                data-id="<%= chat.membersInfo[prop].id %>" \n\t\t\t\t                <% } %>\n\t\t\t\t                >\n\t\t\t\t    \t</div>\n\t\t\t\t    \t<% if(chat.membersInfo[prop].name){ %>\n\t\t\t\t\t    <span class="chat-name">\n\t\t\t\t\t    \t<%= chat.membersInfo[prop].name %>\n\t\t\t\t\t    </span>\n\t\t\t\t\t    <% } %>\n\t\t\t\t    <% } %> \n\t\t\t    <% } %>\n\t        </div>\n </div>\n\n<div class="messages-container">\n\t<div class="messages">\n\t    <% if(chat.messages){ %>\n\t    \t<% for(var prop in chat.messages){ %>\n\t    \t\t<% if(chat.messages[prop]){ %>\n\t    \t\t    <div class="day-container">\n\t    \t\t        <span class="date"><% if(chat.messages[prop].date){print(chat.messages[prop].date)}%></span>\n\t    \t\t    \t<% for(var message in chat.messages[prop]){ %>\n\t    \t\t    \t     <% if(chat.messages[prop][message].text && chat.messages[prop][message].idDog && currentUserDog.id){ %>\n \t\t\t\t\t\t\t\t<div class="message-container <% if(chat.messages[prop][message].idDog === currentUserDog.id){ print(\'right\')} else {print(\'left\')}%>" >\n\t\t\t\t\t\t    \t\t<span class="message" <% if(chat.messages[prop][message].id){ %> \n\t\t\t\t\t\t    \t\t\t\t\t\t\t  data-id="<%= chat.messages[prop][message].id %>"\n\t\t\t\t\t\t    \t\t\t\t\t\t\t  <% } %>>\n\t\t\t\t\t\t    \t\t\t<%= chat.messages[prop][message].text %>\n\t\t\t\t\t\t    \t\t</span>\n\t\t\t\t\t\t    \t\t<span class="message-time"><%= chat.messages[prop][message].time %></span>\n\t\t\t\t\t    \t\t</div>\n\t    \t\t    \t     <% } %>\n\t    \t\t    \t<% } %>\n\t    \t\t    </div>\n\t    \t\t<% } %>\n\t    \t<% } %>\n\t    <% } %>\n\t</diV>\n</div>\n\n<div class="toolbar">\n\t<div class="toolbar-container">\n\t\t<input class="input message-input" type="text" placeholder="Сообщение...&#9998;">\n\t\t<button class="send-message">&#10148;</button>\n\t</div>\n</div>\n<% } %>';});

define('views/chatRoomView',['underscore', 'text!templates/chatRoomTemplate.html', 'radio', 'jquery', 'fb'],
...
define('controllers/chatRoomController',['models/chatRoomModel','views/chatRoomView','radio','fb','ym'],
...
define('controllers/chatController',['models/chatModel','views/chatView','controllers/chatRoomController','radio','fb','ym'],
...
define('models/settingsModel',[],function () {
...
define('text!templates/settingsTemplate.html',[],function () { return '<div class="container">\n<% if(user){ %>\n\n    <div class="add-dog-button-container">\n            <button class="add-dog">Добавить ещё одну собаку +</button>\n    </div>\n\n<% } else { %>\n    <div>\n        <h4 class="title is-4">Для того, чтобы воспользоваться данной функцией Вам необходимо <a href="#signUpStep1">зарегистрироваться</a></h4>\n    </div>\n<% } %>\n</div>';});

define('views/settingsView',['underscore', 'text!templates/settingsTemplate.html', 'radio','jquery','fb'],
...
define('controllers/settingsController',['models/settingsModel', 'views/settingsView', 'radio', 'fb'],
